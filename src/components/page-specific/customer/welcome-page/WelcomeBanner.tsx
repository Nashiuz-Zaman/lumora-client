...
export const WelcomeBanner = ({ name, subtitle }: IWelcomeBannerProps) => (
  <div className="relative overflow-hidden rounded-2xl flex items-center justify-between bg-linear-to-r from-primary-light-2 to-primary text-zinc-50 shadow-md">
    ...
    <div className="relative z-10 px-6 py-8 sm:px-10 md:px-12 w-[65%]">
      ...
      <p className="text-sm sm:text-base text-zinc-50/90 max-w-md">{subtitle}</p>
    </div>
  </div>
);
