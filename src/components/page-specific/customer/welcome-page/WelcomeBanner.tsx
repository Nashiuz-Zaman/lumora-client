...
export const WelcomeBanner = ({ name, subtitle }: IWelcomeBannerProps) => (
  <div className="relative overflow-hidden rounded-2xl flex items-center justify-between bg-linear-to-r from-primary-light-2 to-primary text-white shadow-md">
