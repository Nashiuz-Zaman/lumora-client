...
export const LinkCard = ({
  ...
  return (
    <Link
      href={href}
      className="group bg-white rounded-2xl border border-neutral-100 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all p-8 flex flex-col items-center text-center"
    >
