...
export const AddressCard = ({
  ...
  return (
    <article className="relative h-full rounded-2xl border border-zinc-100 bg-white p-6 shadow-md">
      <div className="flex h-full flex-col justify-between">
        <div>
          ...
          {hasAddress ? (
            <address className="space-y-1 not-italic text-sm text-zinc-600 sm:text-base">
