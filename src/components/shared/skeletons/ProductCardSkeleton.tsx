export const ProductCardSkeleton = () => {
  return (
    <div className="flex flex-col p-4 h-full animate-pulse border border-transparent">
      {/* Badge Placeholder */}
      <div className="h-5 w-20 bg-zinc-200 mb-3" />

      {/* Product Image Placeholder */}
      <div className="mx-auto mt-3 mb-3.5 h-28 aspect-square bg-zinc-200 rounded-md" />
      ...
      <div className="mt-auto">
        <div className="flex justify-center gap-1 mb-3">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="h-4 w-4 bg-zinc-100 rounded-full" />
          ))}
        </div>
        ...
        {/* Brand Placeholder */}
        <div className="h-3 w-20 bg-zinc-100 rounded mx-auto mb-5" />
