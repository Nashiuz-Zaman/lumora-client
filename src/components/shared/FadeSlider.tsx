    ...
    >
      ...
      {slideNavigator && (
        <>
          <button
            onClick={prevSlide}
            className="absolute left-2 y-center bg-black/50 text-zinc-50 p-2 rounded-full hover:bg-black/70"
          >
            ‹
          </button>
          <button
            onClick={nextSlide}
            className="absolute right-2 y-center bg-black/50 text-zinc-50 p-2 rounded-full hover:bg-black/70"
          >
            ›
          </button>
        </>
